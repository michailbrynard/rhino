															...
															<div key={index} className='col-12'>
																<Paper style={style.card} zDepth={3}>
																	...
																	<div style={style.card_right} className='right'>
																		...
																		<RaisedButton disabled={item.user_limit === item.user_count} onClick={() => this.setState({ perk_amount: item.perk_amount, perk_name: item.perk_name, perk_id: item.identifier })} className="f-right" primary={true} label="Redeem"/>
																	</div>
																</Paper>
																<br />
															</div>
